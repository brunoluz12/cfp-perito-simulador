...
const PFISTER_COLORS = {
    'Az1': { hex: '#ADD8E6', name: 'Azul 1', family: 'Az', textColor: '#000' },
    'Az2': { hex: '#00BFFF', name: 'Azul 2', family: 'Az', textColor: '#000' },
    'Az3': { hex: '#0000FF', name: 'Azul 3', family: 'Az', textColor: '#FFF' },
    'Az4': { hex: '#00008B', name: 'Azul 4', family: 'Az', textColor: '#FFF' },
    'Vm1': { hex: '#FF746C', name: 'Vermelho 1', family: 'Vm', textColor: '#000' },
    'Vm2': { hex: '#FF2C2C', name: 'Vermelho 2', family: 'Vm', textColor: '#FFF' },
    'Vm3': { hex: '#FF0000', name: 'Vermelho 3', family: 'Vm', textColor: '#FFF' },
    'Vm4': { hex: '#B22222', name: 'Vermelho 4', family: 'Vm', textColor: '#FFF' },
    'Vd1': { hex: '#90EE90', name: 'Verde 1', family: 'Vd', textColor: '#000' },
    'Vd2': { hex: '#9ACD1E', name: 'Verde 2', family: 'Vd', textColor: '#000' },
    'Vd3': { hex: '#008000', name: 'Verde 3', family: 'Vd', textColor: '#FFF' },
    'Vd4': { hex: '#2E8B57', name: 'Verde 4', family: 'Vd', textColor: '#FFF' },
    'Vi1': { hex: '#B19CD9', name: 'Violeta 1', family: 'Vi', textColor: '#000' },
    'Vi2': { hex: '#80009E', name: 'Violeta 2', family: 'Vi', textColor: '#FFF' },
    'Vi3': { hex: '#640096', name: 'Violeta 3', family: 'Vi', textColor: '#FFF' },
    'La1': { hex: '#FFBE65', name: 'Laranja 1', family: 'La', textColor: '#000' },
    'La2': { hex: '#FF7F00', name: 'Laranja 2', family: 'La', textColor: '#000' },
    'Am1': { hex: '#FFEB00', name: 'Amarelo 1', family: 'Am', textColor: '#000' },
    'Am2': { hex: '#FFB100', name: 'Amarelo 2', family: 'Am', textColor: '#000' },
    'Ma1': { hex: '#966E46', name: 'Marrom 1', family: 'Ma', textColor: '#FFF' },
    'Ma2': { hex: '#654321', name: 'Marrom 2', family: 'Ma', textColor: '#FFF' },
...
function analyzeFormal(pyramidData) {
    ...
    symmetryPairs.forEach(([a, b]) => {
        if (cells[a] && cells[a] === cells[b]) symMatches++;
    });
    ...
    if ((formal === 'tapete puro' || formal === 'tapete com início de ordem') && numFamilies > 1) {
        if (Object.values(cells).includes('Br1')) {
            formal = 'tapete furado/rasgado';
        }
    }
...
function analyzeExecution() {
    ...
    if (orderedCount >= 2) return 'METÓDICA/SISTEMÁTICA';
...
function calculateScore(colorAnalysis, syndromesData, formalAnalyses, execution) {
    ...
    formalAnalyses.forEach((fa, i) => {
        ...
        } else if (fa.formal === 'tapete furado/rasgado') {
            score -= 2;
            negatives.push(`Pirâmide ${label}: tapete furado/rasgado — indício de dificuldades de integração; ponto crítico para a PF.`);
        } else {
            score -= 2;
