...
function calculateScore(colorAnalysis, formalAnalyses, execution) {
    ...
    else if (ca['Az'].obs === 0) { score -= 2; negatives.push('Azul ausente — possível dificuldade de controle emocional.'); }
    ...
    if (ca['Pr'].obs > 5) { score -= 2; negatives.push('Preto excessivo — indicadores de negativismo ou depressão.'); }
